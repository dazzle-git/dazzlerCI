...
var msgBoxImagePath = l.protocol + "//" + l.host + "/" + "images/";
jQuery.msgBox = msg;
function msg(options) {
    ...
    var divTitle = "";
    var divContainer = "<div class=\"msgBoxContainer\"><h2 class=\"msgbox-title\">"+options.title+"</h2><div class=\"msgbox-wrap cf\"><div id=" + divMsgBoxImageId + " class=\"msgBoxImage\"><img src=\"" + msgBoxImagePath + image + "\"/></div><div id=" + divMsgBoxContentId + " class=\"msgBoxContent\"><div class=\"content\"><div>" + options.content + "</div></div></div></div></div>";
